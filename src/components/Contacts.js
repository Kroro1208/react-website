        ...
        <section className='w-full h-fit px-[40px] md:py-20 lg:pb-40 lg:pt-10 py-10 max-xs:px-[20] relative bg-whitesmoke' id="contact">
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='inline-block'>
                    <p className='bg-blue text-white text-sm font-medium py-3 px-5 rounded-full flex items-center gap-1 mb-10'>
                        <span>
                            <AiFillBulb />
                        </span>
                        Contact
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                    ...
                    {/* 右 */}
                    <div>
                        <h2 className='mb-5'>お問い合わせフォーム</h2>
                        <form ref={form} onSubmit={sendEmail} className="w-full">
                            ...
                            <div className='flex justify-end'>
                                <button type='submit' className='bg-blue text-white font-medium py-3 px-6 rounded-xl hover:shadow-xl hover:bg-blue-600'>送信</button>
                            </div>
                        </form>
                    </div>
                </div>
